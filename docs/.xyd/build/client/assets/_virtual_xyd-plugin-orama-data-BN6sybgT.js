 ...
 */}`},{category:"",path:"/docs/get-started/frameworks",title:"Web frameworks",description:`Web frameworks
...
Sample Angular app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/angular)
View on GitHub`,content:`Angular
In your src/app/app.component.ts, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In your 
src/app/app.component.ts
...
Sample Angular app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/angular)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#astro",title:"Astro",description:`Astro
...
Sample Astro app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/astro)
View on GitHub`,content:`Astro
In your src/components/LiveSession.astro, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In your 
src/components/LiveSession.astro
...
Sample Astro app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/astro)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#nextjs",title:"Next.js",description:`Next.js
...
Sample Next.js app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/next)
View on GitHub`,content:`Next.js
In your src/app/livesession.tsx, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In your 
src/app/livesession.tsx
...
Sample Next.js app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/next)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#nuxt",title:"Nuxt",description:`Nuxt
...
Sample Nuxt app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/nuxt)
View on GitHub`,content:`Nuxt
Create a plugin for LiveSession in plugins/livesession.ts and initialize LiveSession using your project tracking code.
You can find it in your project settings.
Create a plugin for LiveSession in 
plugins/livesession.ts
...
Sample Nuxt app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/nuxt)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#react",title:"React",description:`React
...
Sample React app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/react)
View on GitHub`,content:`React
In your src/main.tsx, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In your 
src/main.tsx
...
Sample React app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/react)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#react-router",title:"React Router",description:`React Router
...
Sample React Router app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/react-router)
View on GitHub`,content:`React Router
In your app/components/LiveSession.tsx, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In your 
app/components/LiveSession.tsx
...
Sample React Router app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/react-router)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#svelte-sveltekit",title:"Svelte (SvelteKit)",description:`Svelte (SvelteKit)
...
Sample Svelte app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/sveltekit)
View on GitHub`,content:`Svelte (SvelteKit)
In src/routes/+layout.ts, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In 
src/routes/+layout.ts
...
Sample Svelte app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/sveltekit)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#vue",title:"Vue",description:`Vue
...
Sample Vue app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/vue)
View on GitHub`,content:`Vue
In src/main.ts, initialize LiveSession using your project tracking code.
You can find it in your project settings.
In 
src/main.ts
...
Sample Vue app, you can 
[View on GitHub](https://github.com/livesession/livesession-browser-samples/tree/master/vue)
View on GitHub`},{category:"",path:"/docs/get-started/frameworks#gatsby",title:"Gatsby",description:`Gatsby
...
href="/docs/api/quickstart"
Explore the API reference and documentation for more details.
</GuideCard>`},{category:"",path:"/docs/capabilities/user-paths",title:'User paths <Badge kind="warning">Canary</Badge>',description:`User paths 
<Badge kind="warning">
Canary
</Badge>
<Subtitle>
...
</Tabs>`},{category:"",path:"/docs/api/authentication#rate-limits",title:"Rate limits",description:`Rate limits
...
Examples:
Examples:
Examples:`},{category:"",path:"/docs/api/webhooks/configuration",title:"Configuration",description:`Configuration
<Subtitle>
...
}`}],n=null,t=["How to install xyd?","How to generate API Docs?","How to built-in components?"],s={docs:e,cloudConfig:n,suggestions:t};export{s as default};
