...
import { ServerRouter, useParams, useLoaderData, useActionData, useMatches, Meta, Links, ScrollRestoration, Scripts, Outlet, redirect } from "react-router";
import { isbot } from "isbot";
import { renderToPipeableStream } from "react-dom/server";
import React, { createElement } from "react";
import path from "node:path";
import { compileBySlug as compileBySlug$1 } from "@xyd-js/content";
...
import { compile as compile$1 } from "@mdx-js/mdx";
...
async function loader$1({
  ...
  var _a, _b;
  const slug = getPathname$1(request.url || "index") || "index";
  ...
  let error;
  try {
    code = await compileBySlug$1(slug, true);
  } catch (e) {
    error = e;
  }
  if ((error == null ? void 0 : error.code) === "ENOENT") {
    try {
      code = await compileBySlug$1(slug + "/index", true);
    } catch (e) {
      error = e;
    }
  }
  const {
    ...
    breadcrumbs,
    navlinks
  } = await mapSettingsToProps(settings, slug);
  if (error) {
    if (sidebarGroups && error.code === "ENOENT") {
      const firstItem = (_b = (_a = sidebarGroups == null ? void 0 : sidebarGroups[0]) == null ? void 0 : _a.items) == null ? void 0 : _b[0];
      if (firstItem) {
...
function mdxContent$1(code) {
  const content = mdxExport$1(code);
  if (!mdxExport$1) {
    return {};
  }
  return {
    component: content == null ? void 0 : content.default,
    toc: content == null ? void 0 : content.toc,
    frontmatter: content == null ? void 0 : content.frontmatter,
    themeSettings: (content == null ? void 0 : content.themeSettings) || {},
    page: (content == null ? void 0 : content.page) || false
  };
}
function MemoMDXComponent$1(codeComponent) {
  return React.useMemo(() => codeComponent ? codeComponent : null, [codeComponent]);
}
const docs = withComponentProps(function CustomPage({
  loaderData,
  ...rest
}) {
  const content = mdxContent$1(loaderData.code);
  const Component = MemoMDXComponent$1(content.component);
  return /* @__PURE__ */ jsx(Framework, {
    settings,
    sidebarGroups: loaderData.sidebarGroups || [],
    toc: content.toc || [],
    breadcrumbs: loaderData.breadcrumbs || [],
    navlinks: loaderData.navlinks,
    children: (content == null ? void 0 : content.page) ? /* @__PURE__ */ jsx(Component, {
      components: {
        ...contentComponents$1,
        // TODO: another page components
        HomePage: (props) => /* @__PURE__ */ jsx(HomePage, {
          ...props,
          header: /* @__PURE__ */ jsx("div", {
            style: {
              marginLeft: "var(--xyd-global-page-gutter)"
            },
            children: /* @__PURE__ */ jsx(FwNav, {
              kind: "middle"
            })
          }),
      ...
      children: Component ? /* @__PURE__ */ jsx(Component, {
        components: contentComponents$1
...
const route2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  MemoMDXComponent: MemoMDXComponent$1,
  default: docs,
  loader: loader$1
}, Symbol.toStringTag, { value: "Module" }));
...
async function compileBySlug(slug) {
  let filePath = path$1.join(process.cwd(), `${slug}.md`);
  try {
    await promises.access(filePath);
  } catch (_) {
    filePath = path$1.join(process.cwd(), `${slug}.mdx`);
    await promises.access(filePath);
  }
...
async function compile(content) {
  const compiled = await compile$1(content, {
    remarkPlugins: [normalizeCustomHeadings, [remarkCodeHike, codeHikeOptions], remarkFrontmatter, remarkMdxFrontmatter, remarkGfm],
    rehypePlugins: [],
    recmaPlugins: [[recmaCodeHike, codeHikeOptions]],
...
async function loader({
  ...
  if (!mapSettingsToPropsMap[slug]) {
    data = await mapSettingsToProps(settings, slug);
  ...
  if (error) {
    if (sidebarGroups && error.code === "ENOENT") {
      const firstItem = findFirstUrl((_a = sidebarGroups == null ? void 0 : sidebarGroups[0]) == null ? void 0 : _a.items);
      if (firstItem) {
...
function MemoMDXComponent(codeComponent) {
  return React.useMemo(() => codeComponent ? codeComponent : null, [codeComponent]);
}
...
const apiReference = withComponentProps(function APIReference({
  loaderData
}) {
  ...
  return /* @__PURE__ */ jsx(Framework, {
    ...
    children: /* @__PURE__ */ jsx(Theme, {
      ...
      children: /* @__PURE__ */ jsx(AtlasLazy, {
        references: (memoizedServerComponent == null ? void 0 : memoizedServerComponent.references) || [],
...
const serverManifest = { "entry": { "module": "/assets/entry.client-vAsjergA.js", "imports": ["/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-fYNNSFGn.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/root-CZAIEpvT.js", "imports": ["/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-fYNNSFGn.js", "/assets/with-props-Cl0NfzLN.js"], "css": [] }, "/usr/local/lib/node_modules/@xyd-js/cli/.cli/plugins/xyd-plugin-zero/src/pages/docs": { "id": "/usr/local/lib/node_modules/@xyd-js/cli/.cli/plugins/xyd-plugin-zero/src/pages/docs", "parentId": "root", "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/docs-Ce5eEqCC.js", "imports": ["/assets/with-props-Cl0NfzLN.js", "/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-Du-aOQqn.js", "/assets/index-fYNNSFGn.js"], "css": ["/assets/index-B4-BwAXX.css"] }, "xyd-plugin-zero/docs": { "id": "xyd-plugin-zero/docs", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/docs-Ce5eEqCC.js", "imports": ["/assets/with-props-Cl0NfzLN.js", "/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-Du-aOQqn.js", "/assets/index-fYNNSFGn.js"], "css": ["/assets/index-B4-BwAXX.css"] }, "xyd-plugin-zero/graphql-0": { "id": "xyd-plugin-zero/graphql-0", "parentId": "root", "path": "docs/api/graphql/*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api-reference-CXLd52WE.js", "imports": ["/assets/with-props-Cl0NfzLN.js", "/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-Du-aOQqn.js", "/assets/index-fYNNSFGn.js"], "css": ["/assets/index-B4-BwAXX.css"] }, "xyd-plugin-zero/openapi-0": { "id": "xyd-plugin-zero/openapi-0", "parentId": "root", "path": "docs/api/rest/*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api-reference-CXLd52WE.js", "imports": ["/assets/with-props-Cl0NfzLN.js", "/assets/chunk-SYFQ2XB5-Dd2gfocI.js", "/assets/index-Du-aOQqn.js", "/assets/index-fYNNSFGn.js"], "css": ["/assets/index-B4-BwAXX.css"] } }, "url": "/assets/manifest-d2df649f.js", "version": "d2df649f" };
const assetsBuildDirectory = "../../../../../../../Users/zdunecki/Code/livesession/livesession-docs-temporary/docs/.xyd/build/client";
const basename = "/";
...
const routes = {
  ...
  "/usr/local/lib/node_modules/@xyd-js/cli/.cli/plugins/xyd-plugin-zero/src/pages/docs": {
    id: "/usr/local/lib/node_modules/@xyd-js/cli/.cli/plugins/xyd-plugin-zero/src/pages/docs",
    parentId: "root",
    path: "",
    index: void 0,
    caseSensitive: void 0,
  ...
  "xyd-plugin-zero/graphql-0": {
    id: "xyd-plugin-zero/graphql-0",
    parentId: "root",
  ...
  "xyd-plugin-zero/openapi-0": {
    id: "xyd-plugin-zero/openapi-0",
    parentId: "root",
    path: "docs/api/rest/*",
    index: void 0,
    caseSensitive: void 0,
