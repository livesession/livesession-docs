...
## Overview
LiveSession collects data about [user interactions](https://livesession.io), such as clicks, scrolls or touches in different platforms like [web](https://livesession.io)
or [mobile](https://livesession.io). Each platform can be accessed in different environment like [specific framework](https://livesession.) or using a raw protocol like http.
...
<Tabs items={["Browser", "Frameworks", "API"]}>
    <Tabs.Content value="Browser">
        <Content>
            ...
            ```
            More details about events API can be found [here](https://livesession.io).
        </Content>
    </Tabs.Content>
...
## Samples
The [LiveSession Samples](https://livesession.io) has several end-to-end examples to help you start in different platforms.
<GuideCard
    icon={<IconCode/>}
    title="Quickstart"
>
