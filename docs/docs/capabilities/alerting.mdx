...
<Callout>
    Based on above example, please make sure you used `Browser SDK` custom event tracking like
...
<GuideCard
    ...
    href="https://github.com/livesession/livesession-samples/tree/master/capabilities/alerting"
>
