...
## Overview
LiveSession collects data about [user interactions](https://livesession.io), such as clicks, scrolls or touches in different platforms like [web](https://en.wikipedia.org/wiki/Web_application)
