...
<Tabs items={["Browser", "Frameworks", "API"]}>
    <Tabs.Content value="Browser">
        <Content>
            ...
            #### Send events
            Most of events are [autocaptured](https://livesession.io) by LiveSession, but you can also send custom
            events.

            :::code-group{title="Send events"}
            ```js sdk
            import ls from "@livesession/browser";
    ...
    <Tabs.Content value="API">
        <Content>
            ...
            [Create a PAT in the dashboard here](https://livesession.io), which you'll use to securely [access the
            API](https://livesession.io).
            Store the key in a safe location, like a [`.zshrc file`](https://livesession.io) or another text file on
            your computer.
            Once you've generated a PAT, export it as an [environment variable](https://livesession.io) in your
            terminal.
            ...
            With your LiveSession [Personal Access Token (PAT)](https://livesession.io) exported as an environment
            variable, you're ready to make your first API request.
            You can either use the API directly with the HTTP client of your choice, or use one of our official SDKs as
            shown below.
            ...
            <Tabs ijs="snippet-choose" items={["JavaScript", "curl"]}>
                <Tabs.Content value="JavaScript">
                    <Content>
                        ...
                        like Node.js, Deno, or Bun, you can use the official [LiveSession SDK](https://livesession.io)
